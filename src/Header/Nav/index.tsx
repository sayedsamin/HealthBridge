      ...
      <div className="hidden items-center gap-4 text-base md:flex">
        ...
        <div ref={topicRef} className="relative">
          <button
            ...
            className={`flex items-center gap-1 font-medium transition-colors hover:text-blue-600 ${isTopicActive ? 'text-blue-600' : 'text-slate-700'}`}
          >
            Topics
            <svg
          ...
          {topicOpen && (
            <div className="absolute left-0 top-full z-40 mt-2 w-56 rounded-2xl border border-slate-200 bg-white py-2 shadow-xl">
              <Link
                href="/topic"
              ...
              {topicSubmenus.map((t) => (
                <Link
                  ...
                  href={`/topic/${t.slug}`}
                  onClick={() => setTopicOpen(false)}
                  className={`flex items-center gap-2.5 px-4 py-2 text-sm transition-colors hover:bg-blue-50 hover:text-blue-700 ${
        ...
        >
          <div className="flex flex-col gap-2 text-sm">
            ...
            <button
              ...
              className={`flex w-full items-center justify-between rounded-lg px-3 py-2 font-medium transition-colors hover:bg-slate-50 ${isTopicActive ? 'text-blue-600' : 'text-slate-700'}`}
            >
              Topic
              <svg
