...
const FALLBACK = {
  ...
  subtitle:
    'Stay informed about emergency services, legal protections, and practical steps to stay safe.',
  ...
  sections: [
    {
      ...
      description: 'Call 911 for immediate danger, serious injury, fire, or medical emergencies.',
      keyPoints: [
    ...
    },
    {
      ...
      description: 'Learn your rights to training, protective equipment, and refusing unsafe work.',
      keyPoints: ['Right to know hazards', 'Right to participate', 'Right to refuse unsafe work'],
    },
    {
      title: 'Domestic Violence Support',
      description: 'Find confidential support lines, shelters, and legal help for safety planning.',
